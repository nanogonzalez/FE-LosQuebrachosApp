...
@Component({
  selector: 'app-orden-de-carga',
  templateUrl: './orden-de-carga.component.html',
  styleUrls: ['./orden-de-carga.component.css']
})
export class OrdenDeCargaComponent implements OnInit {
